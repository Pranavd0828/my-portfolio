...
import WeatherEngine from '@/components/playground/WeatherEngine';
    ...
    return (
        <WeatherEngine>
            <main className="w-full min-h-screen pt-32 pb-16 px-6 selection:bg-accent/20">
                ...
                <div className="w-full max-w-6xl mx-auto flex flex-col pt-12 md:pt-0">
                    <div className="flex flex-col mb-16 relative z-10">
                        ...
                        <p className="font-sans text-muted max-w-xl text-sm md:text-base leading-relaxed">
                            An isolated environment utilizing the Cinematic Calm design system. This space is validating "Phase 15: Contextual Weather Engine", adapting the site's aesthetics to your physical location.
                        </p>
                    </div>

                    {/* Experimental Content Container */}
                    <div className="w-full min-h-[500px] border border-foreground/10 bg-foreground/[0.02] rounded-2xl flex flex-col items-center justify-center p-8 relative overflow-hidden group">
                        ...
                        <span className="font-mono text-xs text-muted uppercase tracking-widest z-10 text-center">
                            The weather engine is actively overriding global CSS. Try the Dev Controls.
                        </span>
                    </div>
                </div>
            </main>
