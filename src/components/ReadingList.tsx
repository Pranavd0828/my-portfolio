...
const readingData: Record<Year, Book[]> = {
    '2026': [
        ...
        { title: 'The Hitchhiker\'s Guide to the Galaxy', author: 'Douglas Adams', status: 'Read', coverUrl: '/covers/hitchhikers_guide.jpg' }, // Note: 4th read
                                    ...
                                    >
                                        ...
                                        <AnimatePresence>
                                            {book.coverUrl && expandedBookId === bookId && (
                                                ...
                                                >
                                                    <div className="relative w-28 aspect-[2/3] rounded-sm overflow-hidden border-[0.5px] border-white/10">
                                        ...
                                        {book.coverUrl && (
                                            <div className="pointer-events-none absolute right-[10%] top-1/2 -translate-y-1/2 z-0 opacity-0 group-hover:opacity-100 transition-all duration-700 ease-[0.22,1,0.36,1] scale-90 group-hover:scale-110 rotate-3 group-hover:-rotate-3 mix-blend-screen hidden lg:block">
