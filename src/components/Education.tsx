        ...
        <section className="w-full max-w-6xl mx-auto py-16 md:py-32 px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="flex flex-col p-8 md:p-12 border-[0.5px] border-white/10 opacity-80 hover:opacity-100 transition-opacity duration-1000">
                    ...
                    <p className="font-sans text-sm text-muted/80 leading-relaxed mb-4">University of Maryland, College Park</p>
                    <p className="font-sans text-sm text-accent/90 mb-8">Contributed research to <span className="text-white font-medium">The Feeling Economy</span> (Ming-Hui Huang, Roland Rust), focused on AI's impact on customer experience, service strategy, and the rising value of emotional intelligence.</p>
                ...
                <div className="flex flex-col p-8 md:p-12 border-[0.5px] border-white/10 opacity-80 hover:opacity-100 transition-opacity duration-1000">
                    ...
                    <p className="font-sans text-sm text-muted/80 leading-relaxed mb-4">University of Mumbai, India</p>
                    <p className="font-sans text-sm text-accent/90 mb-8">Consecutively ranked first in Applied Mathematics for five semesters.</p>
                    <div className="mt-auto pt-8 border-t-[0.5px] border-white/10 text-xs font-mono uppercase tracking-widest text-muted">
